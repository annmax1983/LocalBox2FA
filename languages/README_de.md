...
> Chromium-basiert · Manifest V3 · Vollständig offline · Datenschutz zuerst
...
| Vorteil | Detail |
|---------|--------|
| 🔒 **Vollständig lokal** | Alle TOTP-Berechnungen erfolgen im Browser über die Web Crypto API. Kein Upload. |

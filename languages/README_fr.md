...
> Basé sur Chromium · Manifest V3 · Entièrement hors ligne · Confidentialité d'abord
...
| Avantage | Détail |
|----------|--------|
| 🔒 **Entièrement local** | Tous les calculs TOTP s'effectuent dans votre navigateur via l'API Web Crypto. Aucun upload. |
